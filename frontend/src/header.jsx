...
export default function Header (){
 ...
 <a className='absolute flex rounded-lg shadow-2xl shadow-blue-600 justify-around w-[90%] sm:w-1/2  md:h-[90%] md:w-2/3 lg:w-1/2 h-full top-[50%] bg-[#232b41]'>
...
<div className=' flex flex-col items-center justify-around h-full '>
    <text className='m-5 text-white' >Dayvison da Paz</text></div> 

    <div className='h-[10%] absolute w-full justify-end flex bottom-3 text-white'>
        <img className='mr-2 h-[3vh] ' src="https://cdn-icons-png.flaticon.com/512/1077/1077042.png" alt="" />
        <img className='mr-2 h-[3vh]' src="https://cdn-icons-png.flaticon.com/512/3291/3291695.png" alt="" />
        <img className="mr-2 h-[3vh]" src='https://cdn-icons-png.flaticon.com/512/3536/3536569.png' alt="" />   
            </div>   
</div>
